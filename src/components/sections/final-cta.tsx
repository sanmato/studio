  ...
  return (
    <section className="relative w-full bg-[#0a192f] text-primary-foreground">
      ...
      <div className="container mx-auto px-4 text-center relative py-20 md:py-28">
        ...
        <Button asChild size="lg" className="h-16 px-12 text-xl font-bold bg-gradient-to-br from-primary to-[hsl(215,80%,45%)] hover:from-primary/90 hover:to-[hsl(215,80%,40%)] transform hover:scale-105 transition-all duration-300">
