...
export function Problem() {
  ...
  return (
    <section id="nosotros" className="relative bg-background text-foreground py-12 md:py-24 lg:py-32">
       {bgImage && (
      ...
      <div className="container mx-auto px-4 text-center relative">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {problems.map((problem) => (
            <Card key={problem.title} className="flex flex-col items-center text-center p-6 rounded-lg bg-card">
